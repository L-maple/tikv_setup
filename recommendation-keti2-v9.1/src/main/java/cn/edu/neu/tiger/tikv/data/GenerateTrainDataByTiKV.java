...
import static cn.edu.neu.tiger.tools.Util.getSample;
import static cn.edu.neu.tiger.tools.TikvUtil.getFilterInfo;
...
public class GenerateTrainDataByTiKV {
  ...
  public static void main(String[] args) throws IOException, Exception {
    ...
    List<Kvrpcpb.KvPair> results =
        (List<Kvrpcpb.KvPair>) storageService.scanData("click", new ArrayList<>(),null,null);
    ...
    try {
      ...
      for (Kvrpcpb.KvPair result : results) {
        ...
        Map<String, String> userInfo =
            getRow(
                ((List<Kvrpcpb.KvPair>) storageService.scanData("user", userFilterInfos,null,null))
                    .get(0)
                    .getValue());
        Map<String, String> itemInfo =
            getRow(
                ((List<Kvrpcpb.KvPair>) storageService.scanData("item", itemFilterInfos,null,null))
                    .get(0)
                    .getValue());
